...
public class LoginToAccountStepDefinitions {
  ...
  public void i_click_on_the_login_button_with_an_incorrect_provided_password() {
    ...
    Assert.assertSame(fiveLeagueFantasyException.getStatus(), HttpStatus.UNAUTHORIZED);
    Assert.assertEquals("Incorrect password.", fiveLeagueFantasyException.getMessage());
  }
